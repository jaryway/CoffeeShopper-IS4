...
var oidc = (() => {
  ...
  var CheckSessionIFrame = class {
    constructor(_callback, _client_id, url, _intervalInSeconds, _stopOnError) {
      ...
      this._message = (e) => {
        console.log('CheckSessionIFrame.message',e);
    ...
    start(session_state) {
      // console.log('this._session_state === session_state',this._session_state === session_state);
      ...
      // setInterval(()=>{
      //   send();
      //   console.log('SessionMonitor.setInterval.000');
  ...
  var SessionMonitor = class {
    constructor(_userManager) {
      ...
      console.log('SessionMonitor.start');
      this._start = async (user) => {
        console.log('SessionMonitor.start__',this._checkSessionIFrame);
